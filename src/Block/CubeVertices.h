...
inline GLfloat blockVertices[] = {
	...
	-0.5f,  0.5f,  0.5f,  1.0f, 1.0f, 0.0f, // top-left
	 ...
	 // right face
	  ...
	  // bottom face
	  -0.5f, -0.5f,  0.5f,  0.0f, 0.0f, 4.0f, // bottom-right
	   0.5f, -0.5f,  0.5f,  1.0f, 0.0f, 4.0f, // bottom-left
	   0.5f, -0.5f, -0.5f,  1.0f, 1.0f, 4.0f, // top-left
	  -0.5f, -0.5f, -0.5f,  0.0f, 1.0f, 4.0f, // top-right

	  // top face
	   0.5f,  0.5f,  0.5f,  0.0f, 0.0f, 5.0f, // bottom-right
	  -0.5f,  0.5f,  0.5f,  1.0f, 0.0f, 5.0f, // bottom-left
	  -0.5f,  0.5f, -0.5f,  1.0f, 1.0f, 5.0f,  // top-left
	   0.5f,  0.5f, -0.5f,  0.0f, 1.0f, 5.0f // top-right
};
